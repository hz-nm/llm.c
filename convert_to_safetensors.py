...
def main():
    ...
    if "gpt2_python_d12.bin" in os.listdir(source_folder):
        convert_file(os.path.join(source_folder, "gpt2_python_d12.bin"), os.path.join(dest_folder, "model.safetensors"), copy_add_data=True)
        if delete_old:
